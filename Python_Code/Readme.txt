...
Pleae install the follliwng library:
...
The spectradictionary is the FEATHER file contains the spectra of various debris. 

For opening the file please use the following code: 

import pyarrow.feather as feather

# Read the Feather file into a DataFrame
df = feather.read_feather('spectradictionary.feather')

# Now 'df' contains the data from the Feather file
print(df.head())
